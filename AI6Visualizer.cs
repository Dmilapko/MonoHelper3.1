...
using static AILib.AI6;

namespace MonoHelper
{
    public class AI6Visualizer : Evo0Visualiser
    { 
        public class NeuronVisualizer:Evo0NeuronVisualizer
        {
            ...
            {
                connectionvisualizers.Add(new AI6ConnectionVisualizer(connection));
            }
        ...
        internal class AI6ConnectionVisualizer:Evo0ConnectionVisualizer
        {
            public double current_flow = 0;
            public SpriteFont textfont;

            public AI6ConnectionVisualizer(AIFamilyEvo0.ConnectionFamilyEvo0 connection) : base(connection)
            {
            }
        ...
        public AI6Visualizer(GraphicsDevice graphicsDevice, AIFamilyEvo0 ai, int widthpx, int heightpx, SpriteFont textfont) :base(graphicsDevice, ai, widthpx, heightpx)
        {
            foreach (NeuronVisualizer item in neuronvisualizers)
            {
                item.textfont = textfont;
                foreach (AI6ConnectionVisualizer convis in item.connectionvisualizers)
                {
        ...
        public AI6Visualizer(GraphicsDevice graphicsDevice, AIFamilyEvo0 ai, int widthpx, int heightpx, SpriteFont textfont, Color textcolor, Color connectioncolor) : base(graphicsDevice, ai, widthpx, heightpx)
        {
        ...
        public override void PreProcess()
        {
            foreach (NeuronVisualizer nvis in neuronvisualizers)
            {
                ...
                foreach (AI6ConnectionVisualizer convis in nvis.connectionvisualizers)
                {
                    convis.current_flow = nvis.neuron.value * ((AI6.Connection)convis.connection).weight;
                }
            }
        }
